                                ...
                                <div class="details_slider owl-carousel">
                                    @foreach ($details->variables as $value)
                                        <div class="dimage_item">
                                            ...
                                            <a href="{{ asset($value->image) }}" download class="download-btn"><i class="fa-solid fa-download"></i></a>
                                        </div>
                                    @endforeach
                                </div>
                                    ...
                                    <div class="product">
                                        <div class="product-cart">
                                            ...
                                            <p class="details-price">
                                                @if ($details->variable->old_price)
                                                    <del>৳ <span class="old_price">{{ $details->variable->old_price }}</span></del>
                                                @endif ৳ <span class="new_price">{{ $details->variable->new_price }}</span>
                                            </p>
                                            @else
                                            <p class="details-price">
                                                @if ($details->old_price)
