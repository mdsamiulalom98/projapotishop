   ...
   @media print {
    td{
       ...
       header,footer,.no-print {
        ...
        .mobile-menu, .scrolltop, .fixed_whats a {
           display: none !important; 
        }
  }
</style>
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice-bar" style="background:#fff; transform: skew(36deg); width: 80%; margin-left: 148px; padding: 12px 32px; margin-top: 6px;text-align:right">
