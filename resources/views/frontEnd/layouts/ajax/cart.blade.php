...
<table class="cart_table table table-bordered table-striped text-center mb-0">
    <thead>
        <tr>
            <th style="width: 20%;" class="potro-sans">ডিলিট</th>
            <th style="width: 40%;" class="potro-sans">প্রোডাক্ট</th>
            <th style="width: 20%;" class="potro-sans">পরিমাণ</th>
            <th style="width: 20%;" class="potro-sans">মূল্য</th>
        </tr>
    </thead>
    ...
    <tfoot>
        <tr>
            <th colspan="3" class="text-end px-4 potro-sans">মোট</th>
            <td class="px-4">
        ...
        <tr>
            <th colspan="3" class="text-end px-4 potro-sans">ডেলিভারি চার্জ</th>
            <td class="px-4">
        ...
        <tr>
            <th colspan="3" class="text-end px-4 potro-sans">ডিসকাউন্ট</th>
            <td class="px-4">
                <span id="cart_shipping_cost"><span class="alinur">৳
        ...
        <tr>
            <th colspan="3" class="text-end px-4 potro-sans">সর্বমোট</th>
            <td class="px-4">
