                            ...
                            <div class="col-sm-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('commision') is-invalid @enderror"
                                        name="commision" value="{{ $edit_data->commision }}" id="commision">
                                    @error('commision')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    @foreach ($variables as $variable)
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <a href="{{ route('products.variableimage.destroy', ['id' => $variable->id]) }}"
                                                    class="btn btn-xs btn-danger waves-effect waves-light"><i
                                                        class="mdi mdi-close"></i></a>
                                            </div>
                                            <!-- col end -->
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control @error('meta_image') is-invalid @enderror"
                                        name="meta_image" value="{{ $edit_data->meta_image }}" id="meta_image" />
                                    <img src="{{ asset($edit_data->meta_image) }}" class="edit-image border"
                                        alt="" />
                                    @error('meta_image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="free_shipping"
                                            @if ($edit_data->free_shipping == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('free_shipping')
                                        <span class="invalid-feedback" role="alert">
