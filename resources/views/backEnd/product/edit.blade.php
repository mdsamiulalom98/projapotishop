          ...
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <input type="hidden" value="{{$edit_data->id}}" name="id" />
             ...
             <div class="col-sm-12">
              <div class="form-group mb-3">
                <label for="slug" class="form-label">Permalink/url/slug *</label>
            ...
            <div class="col-sm-4">
              <div class="form-group mb-3">
                ...
                <select class="form-control select2 @error('type') is-invalid @enderror" disabled value="{{ old('type') }}" id="product_type" name="type">
               ...
               <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                  <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control @error('meta_image') is-invalid @enderror" name="meta_image" value="{{$edit_data->meta_image}}" id="meta_image" />
                     <img src="{{asset($edit_data->meta_image)}}" class="edit-image border" alt="" />
                    @error('meta_image')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
