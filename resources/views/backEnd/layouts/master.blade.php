            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    <ul id="side-menu">
                        ...
                        <!-- nav items end -->
                        <li>
                            <a href="#siebar-offers" data-bs-toggle="collapse">
                                <i data-feather="percent"></i>
                                <span> Offers & Deals </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="siebar-offers">
                                <ul class="nav-second-level">
                                    <li>
                        ...
                        <li class="{{ request()->is('admin/customer/manage*') ? 'menuitem-active' : '' }}">
                            ...
                            <div class="collapse {{ request()->is('admin/customer/manage*') ? 'show' : '' }}"
                                id="sidebar-reseller">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 1, 'status' => 'pending']) }}"
                                            {{ request('status') == 'active' ? 'active' : '' }}><i
                                                data-feather="file-plus"></i> Pending Reseller </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.index', ['type' => 1, 'status' => 'active']) }}"
                                            {{ request('status') == 'active' ? 'active' : '' }}><i
                                                data-feather="file-plus"></i> All Reseller </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customers.rereport', ['type' => 1, 'status' => 'active']) }}"
                                            {{ request('status') == 'active' ? 'active' : '' }}><i
                                                data-feather="file-plus"></i>Reseller Report</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 text-end">&copy; {{ $generalsetting->name }} <a
                                href="https://s2kittechpoint.com/" target="_blank">Md Sabbir</a></div>
                    </div>
                </div>
            </footer>
            <!-- end Footer -->
