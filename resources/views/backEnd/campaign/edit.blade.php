                ...
                <form action="{{route('campaign.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                   ...
                   <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="short_description"  rows="6" class="summernote form-control @error('short_description') is-invalid @enderror" required>{!! $edit_data->short_description !!}</textarea>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <textarea name="why_chooseus"  rows="6" class="summernote form-control @error('why_chooseus') is-invalid @enderror" required>{{$edit_data->why_chooseus}}</textarea>
                            @error('why_chooseus')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
