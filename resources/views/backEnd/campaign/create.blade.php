                ...
                <form action="{{route('campaign.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="short_description"  rows="6" class="summernote form-control @error('short_description') is-invalid @enderror" required></textarea>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('description_title') is-invalid @enderror" name="description_title" value="{{ old('description_title') }}"  id="description_title" required="">
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="why_chooseus"  rows="6" class="summernote form-control @error('why_chooseus') is-invalid @enderror" ></textarea>
                            @error('why_chooseus')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
