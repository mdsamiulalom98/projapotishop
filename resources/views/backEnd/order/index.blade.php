                            ...
                            <table id="datatable-buttons" class="table table-striped w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%">Reseller (C)</th>
                                ...
                                <tbody>
                                    @foreach ($show_data as $key => $value)
                                        <tr>
                                                ...
                                                <div class="button-list custom-btn-list">
                                                    ...
                                                    @if ($pathao_info)
                                                        <a data-bs-toggle="modal"
                                                            data-bs-target="#pathao{{ $value->id }}"
                                            ...
                                            <td>৳{{ $value->amount }}</td>
                                            <td>
                                                <span class="font-14 badge bg-{{ $value->status ? $value->status->color : 'primary' }}">
            ...
            $(document).on('click', '.multi_order_courier', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.status == 'success') {
                            toastr.success('Your order place to courier successfully');
                        } else {
                            toastr.error('Failed something wrong');
                        }
                    }
